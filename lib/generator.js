...
async function guideManualRepositorySetup(config) {
  ...
  console.log(`   a) Go to: https://github.com/new?template_name=vana-satya-proof-template-py&template_owner=vana-com&name=${suggestedNames.proof}&visibility=public`);
